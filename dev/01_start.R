...
golem::fill_desc(
  pkg_name = "golemShinyApp", # The Name of the package containing the App 
  pkg_title = "Test ShinyApp (using Golem)", # The Title of the package containing the App 
  pkg_description = "This is a shinyapp package using golem.", # The Description of the package containing the App 
  author_first_name = "Ji won", # Your First Name
  author_last_name = "Chang",  # Your Last Name
  author_email = "nyujwc331@gmail.com",      # Your Email
